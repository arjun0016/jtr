  ...
  return (
    ...
    <div>
        ...
        <div className="category-detailspagec">
          ...
          <div className="category-details-wrap">
           ...
           {categoryDetails.imgKit1 && <img id="kit" src={categoryDetails.imgKit1} alt="" />}
            ...
            {categoryDetails.img3 && <div className="text-center"><a href={categoryDetails.alink3}>
              {categoryDetails.thirdh5 && <h5 className="mt-5">{categoryDetails.thirdh5}</h5>}
             <img id="co" src={categoryDetails.img3} alt="" />
             </a>
             </div>}

           {categoryDetails.img50 && <div className="text-center mt-5"><a href={categoryDetails.alink50}>           
            {categoryDetails.fourthh5 && <h5 className="mt-5">{categoryDetails.fourthh5}</h5>}
           <img id="co"className="mt-5" src={categoryDetails.img50} alt="" /></a></div>}
          </div>
      ...
      <Link
        ...
        smooth={true}
        to={`/moredetails/${subcategory.subid}`}
      >
        {subcategory.title}
      </Link>
    ))}
              ...
              <button className="btn btn-outline-primary">
                <Link smooth={true} to={`/moredetails/${categoryDetails.subcategory2[0].subid}`}>
                  {categoryDetails.button2}
                </Link>
              </button>
              <button className="btn btn-outline-primary">
                <Link smooth={true} to={`/moredetails/${categoryDetails.subcategory3[0].subid}`}>
          ...
          {categoryDetails.content1 && (
            ...
            {categoryDetails.img24 &&(
              ...
              {categoryDetails.content3 && (
                <p >{categoryDetails.content3}</p>
              )}
